...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_portable_identity_excludes_local_machine_content(self) -> None:
        ...
        self.assertIn("status --json", tool_routing)
        self.assertIn("semble search", tool_routing)
        self.assertIn("rtk pytest", tool_routing)
        self.assertIn("tgrep is experimental", tool_routing)
        self.assertIn("does not install it", tool_routing)
        self.assertNotIn("status -p", tool_routing)
