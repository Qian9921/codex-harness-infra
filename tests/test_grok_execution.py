...
class GrokExecutionTests(unittest.TestCase):
    def test_bound_prompt_covers_implementation_and_concise_result(self) -> None:
        ...
        self.assertIn("check the owner repository CodeGraph index", wrapper)
        self.assertIn("BEFORE code exploration", wrapper)
        ...
        self.assertIn("never dismiss it as not needed", wrapper)
        self.assertIn("Semble stays optional", wrapper)
