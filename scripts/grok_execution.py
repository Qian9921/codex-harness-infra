...
TOOL_SELECTION_GUIDANCE = (
    ...
    "Compact supported pytest summaries: optional `rtk pytest`; use raw commands "
    "for unified diffs, porcelain/JSON, and exact diagnostics. tgrep is "
    ...
    "back to baseline. Optional tools are selected only for a concrete need, "
    "actually invoked when they fit, and missing or failed tools fall back to "
    "baseline. This is prompt guidance, not a classifier or gate."
)
